...
// KEY LENGTH 
static char mColumns[4][4] = {{0x02,0x03,0x01,0x01},{0x01,0x02,0x03,0x01},{0x01,0x01,0x02,0x03},{0x03,0x01,0x01,0x02}};
// Sbox AND Reverse Sbox 
static char Sbox[KEY_LENGTH][KEY_LENGTH] =  
{
...
static char RSbox[KEY_LENGTH][KEY_LENGTH] = 
{
...
public:
	...
	int encodeAES(char *input, char *output){
	...
	int decodeAES(char *input, char *output){
...
int main(){
	...
	char *encodeArray = "abcdefghijklmnop";
	char *encodeResult = NULL;
	char *decodeArray = NULL;
	char *decodeResult = NULL;

	AES *al = new AES(&key);

	al->encodeAES(encodeArray,encodeResult);
//	AESalgo->encodeAES(inputArray, incodeArray);
//	display(incodeArray);
//	AESalgo->decodeAES(incodeArray, decodeArray);
//	display(decodeArray);
